...
public class MenuUI extends Group {
    ...
    public MenuUI(final GameScreen gameScreen, WorldGame worldGame) {
        ...
        tableGameOver.setBackground(Assets.backgroundWindow);
        tableGameOver.setPosition(getWidth() / 2f - tableGameOver.getWidth() / 2f, 110);

        labelBestScore = new Label("0", Assets.labelStyle);
        ...
        tableGameOver.add(new Label("Score", Assets.labelStyle)).left();
        tableGameOver.add(labelScore).expandX().right();

        tableGameOver.row();
        tableGameOver.add(new Label("Best score", Assets.labelStyle)).left();
    ...
    private void initialize() {
        ...
        buttonFacebook = new Button(Assets.buttonFacebook, Assets.buttonFacebookPress);
        buttonFacebook.setSize(60, 60);
        buttonFacebook.setPosition(Screens.SCREEN_WIDTH + buttonFacebook.getWidth(), 410);

        buttonTwitter = new Button(Assets.buttonTwitter, Assets.buttonTwitterPress);
        ...
        buttonSound = new Button(Assets.buttonSoundOff, Assets.buttonSoundOn, Assets.buttonSoundOn);
        ...
        buttonAchievements = new Button(Assets.buttonAchievements, Assets.buttonAchievementsPress);
